...
/**
 * Base repository class for models.
 *
...
abstract class CommonRepository implements Repository
{
    /**
     ...
     */
    protected function ensureModel(string|Model $model): Model
    {
        return is_string($model) ? $this->model::query()->findOrFail($model) : $model;
    }
